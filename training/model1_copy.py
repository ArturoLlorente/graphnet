...
runName = "comparison_test_1e_batches_55_batch_size_2000"
...
callbacks = [
    ModelCheckpoint(
        dirpath='/remote/ceph/user/l/llorente/training_1e_test/tito_model/model_checkpoint_graphnet/',
