...
def build_model(
    *,
    ...
    detector = IceCubeKaggleTITO(
        graph_builder=KNNGraphBuilderTITO(nb_nearest_neighbours=6, columns=[0,1,2,3])
    )
...
def inference(device: int,
    ...
    model.eval()
    model.inference()
    checkpoint_path = f'/remote/ceph/user/l/llorente/tito_solution/model_graphnet/model4-last.pth'
