...
##    )
    ...
    test_max_pulses = 200
    test_path = '/remote/ceph/user/l/llorente/kaggle/databases_testing/batch_test_val.db'
    test_selection_file = pd.read_csv('/remote/ceph/user/l/llorente/kaggle/databases_testing/batch_test_val_pulses.csv')
    ...
    model.eval()
    model.inference()
    checkpoint_path = '/remote/ceph/user/l/llorente/tito_solution/model_graphnet/model1-last.pth'
    ...
    with torch.no_grad():
        ...
        for batch in tqdm(test_dataloader):
            pred = model(batch.to(f'cuda:{device}'))
    ...
    results.to_csv(f"/remote/ceph/user/l/llorente/graphnet/training/graphnet_results_{test_max_pulses}.csv")